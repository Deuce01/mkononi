...
export const authService = {
  ...
  async loginWorker(phoneNumber: string): Promise<{ worker: WorkerProfile; tokens: AuthResponse }> {
    const response = await api.post('/auth/login/worker/', { phone_number: phoneNumber });
    // Store tokens
  ...
  async registerEmployer(data: EmployerRegistration): Promise<{ employer: Employer; tokens: AuthResponse }> {
  ...
  async getUserProfile(): Promise<{ user_type: 'worker' | 'employer' | 'admin'; profile: any }> {
...
export const workerService = {
  ...
  async updateWorker(id: number, worker: Partial<WorkerProfile>): Promise<WorkerProfile> {
...
export const employerService = {
  ...
  async updateEmployer(id: number, employer: Partial<Employer>): Promise<Employer> {
