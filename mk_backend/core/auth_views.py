...
def register_employer(request):
    ...
    try:
        ...
        company_name = data.get('company_name') or data.get('name')  # Support both field names
        email = data.get('email')
        password = data.get('password')
        phone = data.get('phone') or data.get('phone_number')  # Support both field names
        ...
        sector = sector.lower()
        valid_sectors = ['construction', 'hospitality', 'retail', 'manufacturing', 'agriculture', 'transport', 'other']
...
def get_user_profile(request):
    ...
    # Check if user is an employer
        ...
        return Response({
            'user_type': 'employer',
            'profile': EmployerSerializer(user.employer).data
        })
